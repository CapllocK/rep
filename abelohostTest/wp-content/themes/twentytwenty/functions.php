...
function twentytwenty_register_styles() {
	...
	wp_enqueue_style( 'slider-style', get_template_directory_uri() . '/assets/css/slider.css', array(), $theme_version);
...
function slider( $atts , $content = null ) {
	wp_enqueue_script( 'responsiveslides_js', '/wp-content/themes/twentytwenty/assets/js/slider.js' );
...
require get_template_directory() . '/inc/colors-config.php';
